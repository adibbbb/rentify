        ...
        children: [
          ...
          Stack(
            children: <Widget>[
              ...
              Positioned(
                top: 217, // Sesuaikan posisi tombol ikon gambar di sini
                left: 226,
                right: 134, // Sesuaikan posisi tombol ikon gambar di sini
                child: Transform.scale(
                  scale: 2.1,
                  child: IconButton(
                    icon: Image.asset(
                        'asset/profile/camera.png'), // Icon gambar (ganti dengan yang sesuai)
                    onPressed: () {
                      // Tindakan yang ingin Anda eksekusi saat tombol ikon gambar ditekan
                    },
                  ),
                ),
              ),
          ...
          Padding(
            padding: const EdgeInsets.fromLTRB(0, 300, 0, 110),
            child: ListView(
              children: [
                Padding(
