class WelcomeContent {
  ...
  WelcomeContent(
      {required this.image, required this.title, required this.deskripsi});
}
...
List<WelcomeContent> contents = [
  WelcomeContent(
      ...
      image: 'asset/54.png',
      deskripsi:
          "Explore a curated selection of vehicles tailored to your needs and preferences with our platform."
